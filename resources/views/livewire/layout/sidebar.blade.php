                ...
                <li class="mr-3 flex-1">
                    <a href="/projects" wire:navigate
                        ...
                        <i class="fas fa-tasks pr-0 md:pr-3"></i><span
                            class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Projects</span>
                    </a>
                </li>
                <li class="mr-3 flex-1">
                    <a href="/project_manage" wire:navigate
                        ...
                        <i class="fa fa-envelope pr-0 md:pr-3"></i><span
                            class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Project
                            Add</span>
                    </a>
                </li>
                <li class="mr-3 flex-1">
