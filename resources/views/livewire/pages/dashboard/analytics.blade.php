                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                ...
                                <p class="font-bold text-3xl">$324900 <span class="text-green-500"><i
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                ...
                                <p class="font-bold text-3xl">24900 <span class="text-pink-500"><i
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h2 class="font-bold uppercase text-gray-600">TOTAL PROJECTS</h2>
